...
const Index: React.FC<IndexProps> = () => {
  ...
  return (
    <div
      id="header"
      className="hidden bg-primary-500 opacity-90 md:flex items-center  lg:px-[130px] md:px-[20px] justify-between pt-[11px] pb-[2px] font-open-sans fixed top-0 w-full z-50"
    >
      ...
      <button
        className="bg-btn h-[30px] w-[100px] md:w-[100px] md:h-[40px] bg-cover bg-no-repeat bg-center glow text-[13.44px] md:text-[16px] text-white flex justify-center items-center font-[600]"
